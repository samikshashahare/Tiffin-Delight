                        ...
                        <div className="col col-div">
                            ...
                            <div className="tab-content">
                                ...
                                <div className={active === 2 ? "content active-content" : "content"}>
                                    <h1>Our Mission</h1>
                                    <p>Our mission at TiffinExpress.com is to connect food enthusiasts with culinary inspiration from around the world. We are dedicated to curating a diverse collection of recipes, cooking tips, and restaurant recommendations, providing our users with the knowledge and tools to elevate their dining experiences. With a commitment to excellence and culinary exploration, we aim to empower individuals to savor the joys of cooking and dining.. </p>
                                   
                                </div>

                                <div className={active === 3 ? "content active-content" : "content"}>
                                    <h1>Our vision</h1>
                                    <p>Our vision for TiffinExpress.com is to become the go-to destination for food enthusiasts seeking culinary inspiration and expertise. We aspire to be a trusted resource and community hub for food lovers around the world. We envision a future where individuals, regardless of their cooking skills, can confidently create delicious meals and share memorable dining experiences with their loved ones. </p>
